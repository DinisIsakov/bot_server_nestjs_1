...
export class BotService implements OnModuleInit {
  ...
  async botMessage() {
    ...
    bot.on('new_chat_members', (msg) =>
      bot.sendMessage(
        msg.chat.id,
        `Привет, ${msg.new_chat_members[0].first_name}! Добро пожаловать в чат! Я Bot! Если тебе нужна помощь, то задай свой вопрос и участники группы постараются тебе помочь!`,
      ),
    );
            ...
            [
              {
                ...
                url: 'https://bot-client-nestjs.vercel.app/',
              },
            ],
          ],
        },
